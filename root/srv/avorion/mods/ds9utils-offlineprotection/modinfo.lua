meta =
{
    ...
    name = "OfflinePlayerGuard",

    -- Title of your mod that will be displayed to players
    title = "Offline Player Guard",

    -- Description of your mod that will be displayed to players
    description = "This mod makes player ships and stations invincible when they log out",
